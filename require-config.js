...
require.config({
  ...
  paths: {
    ...
    'bootstrap-hover-dropdown': pathPrefix + 'bower_components/bootstrap-hover-dropdown/bootstrap-hover-dropdown',
    'jquery.ui.widget': pathPrefix + './bower_components/blueimp-file-upload/js/vendor/jquery.ui.widget',
    'jquery.iframe-transport': pathPrefix + 'bower_components/blueimp-file-upload/js/jquery.iframe-transport',
    'jquery.fileupload': pathPrefix + 'bower_components/blueimp-file-upload/js/jquery.fileupload',
    'canvas-to-blob': pathPrefix + 'bower_components/blueimp-canvas-to-blob/js/canvas-to-blob',
    'load-image': pathPrefix + 'bower_components/blueimp-load-image/js/load-image',
    'load-image-exif': pathPrefix + 'bower_components/blueimp-load-image/js/load-image-exif',
    'load-image-ios': pathPrefix + 'bower_components/blueimp-load-image/js/load-image-ios',
    'load-image-meta': pathPrefix + 'bower_components/blueimp-load-image/js/load-image-meta',
    'load-image-orientation': pathPrefix + 'bower_components/blueimp-load-image/js/load-image-orientation',
    'tmpl': pathPrefix + 'bower_components/blueimp-tmpl/js/tmpl',
    'ekko-lightbox': pathPrefix + 'bower_components/ekko-lightbox/dist/ekko-lightbox',
    'bootstrap-touchspin': pathPrefix + 'bower_components/bootstrap-touchspin/dist/jquery.bootstrap-touchspin',
    'secure-handlebars-helpers': pathPrefix + 'bower_components/secure-handlebars-helpers/dist/secure-handlebars-helpers.min'
  },
  shim: {
    'handlebars': {
      exports: 'Handlebars'
